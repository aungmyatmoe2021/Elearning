...
<body>
	...
	<div style='position:fixed;top:25%;left:25%;'>
		...
		<input type='text' name='txtUserRoleName' placeholder="User Role Name" class="userInfoText" id='txtUserRoleName' value='<%= strUserRoleName%>' required/>
		</div>

		<div style='width: 100%;margin-bottom:5px;'>
		<input type='text' name='txtUserRoleDesp' placeholder="User Role Description" class="userInfoText" id='txtUserRoleDesp' value='<%= strUserRoleDesp%>' required/>
		</div>
		...
		<div><input type='hidden' name='hidID' value='<%= strUserRoleID %>' /></div>
		<div><input type='hidden' name='hidStatus' value='<%= strStatus %>' /></div>
		
		<div style='margin-top:20px;'>
			<input type="button" name="butList" value="Back to List" class="back" onclick="location.href='/elearning/userroleinfolist.jsp'"/>
		</div>
