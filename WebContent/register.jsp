	...
	<div style='position: fixed; top: 15%; left: 25%;'>
		...
		<form method='get' name="frmMemberInfoList">
			...
			<div>
				...
				%>
					<option <%= chkUserRoleID %> value="<%= strTemp.split(",")[0] %>"><%= strTemp.split(",")[1] %>
						|
						<%= strTemp.split(",")[2] %></option>
					<%
					}
				%>
				</select>
			...
			<div>
				...
				%>
					<option <%= chkCourseID %> value="<%= strTemp.split(",")[0] %>"><%= strTemp.split(",")[1] %>
						|
						<%= strTemp.split(",")[2] %></option>
					<%
					}
			...
			<div>
				<input type="button" name="butSigin" value="<%= strStatus %>"
					onclick="checkPasswordInfo()" class="sigin" />
			</div>
			...
			<div style='margin-top: 20px;'>
				<input type="button" name="butList" value="Back to List"
					class="back"
					onclick="location.href='/elearning/memberinfolist.jsp'" />
			</div>
		</form>
	</div>
