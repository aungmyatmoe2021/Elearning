...
<script type="text/javascript" src="http://localhost:8080/elearning/js/userroleinfo.js"></script>
<style>
	.center {
	  margin: 15% auto;
	  width: 70%;
...
<body>
	...
	<div class="center">
		<form method="get" name="frmUserInfoList">
			<div><input type="button" name="butNew" value="New" class="addNew" onclick="location.href='/elearning/userroleinfoentry.jsp'"></div>
			<%
